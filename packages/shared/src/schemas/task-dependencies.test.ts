...
import { projectDependencyMapResponseSchema, taskDependencyEdgeSchema, taskDependencySummarySchema } from "./task-dependencies.js";
...
describe("task dependency schemas", () => {
  ...
  it("validates project dependency maps", () => {
    expect(
      projectDependencyMapResponseSchema.parse({
        criticalPathTaskIds: ["11111111-1111-4111-8111-111111111111", "22222222-2222-4222-8222-222222222222"],
        edges: [
          {
            blockedTaskId: "22222222-2222-4222-8222-222222222222",
            blockingTaskId: "11111111-1111-4111-8111-111111111111",
            createdAt: "2026-07-03T12:00:00.000Z",
            id: "33333333-3333-4333-8333-333333333333",
          },
        ],
      ...
      criticalPathTaskIds: ["11111111-1111-4111-8111-111111111111", "22222222-2222-4222-8222-222222222222"],
      stats: { edgeCount: 1, openEdgeCount: 1 },
    });

    expect(
      projectDependencyMapResponseSchema.safeParse({
        criticalPathTaskIds: [],
        edges: [],
        nodes: [],
        stats: { blockedTaskCount: -1, blockingTaskCount: 0, edgeCount: 0, openEdgeCount: 0, readyBlockerCount: 0 },
      }).success,
    ).toBe(false);
  });
});
